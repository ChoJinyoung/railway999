...
<div class="container">
 ...
 <div class="col-lg-10">
    ...
    <form class="form-horizontal" method="post" action="/railway999/freeboard/update">
    <input type="hidden" name="freeboardNo" value="${vo.freeboardNo }"> <!-- 보여줘야할 필요가 없으니까 hidden을 사용하고 번호를 넘겨주기 떄문에 FreeboardNo// No.freeNo이렇게 사용 -->
		<fieldset>
			<div class="form-group">
				<div class="col-lg-12">
					<input type="text" class="form-control" name="freeboardTitle" id="freeboardTitle" value="${vo.freeboardTitle }">
				</div>
			</div>
			<div class="form-group">
			<div class="col-lg-12">
				<textarea class="form-control" rows="10" name="freeboardContent" id="freeboardContent" >${vo.freeboardContent }</textarea>
				</div><br>
