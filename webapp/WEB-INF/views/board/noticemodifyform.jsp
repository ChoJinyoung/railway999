...
<div class="container">
 ...
 <div class="col-lg-10">
    ...
    <form class="form-horizontal" action="/railway999/notice/update" method="post">
		...
		<fieldset>
			...
			<div class="form-group">
			<div class="col-lg-12">
				<textarea  name="content" class="form-control" rows="10" id="textArea" >${notice.content }</textarea>
				</div><br>
            <p class="submitcontent pull-left"><br>
            	<a href="/railway999/notice" type="button" class="btn btn-default btn-sm">취소</a>
